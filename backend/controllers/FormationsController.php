...
use backend\models\FormationsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * FormationsController implements the CRUD actions for Formations model.
 */
class FormationsController extends Controller
{
    ...
    {
        $searchModel = new FormationsSearch();
    ...
    {
        if (($model = Formations::findOne($id)) !== null) {
            return $model;
        } else {
