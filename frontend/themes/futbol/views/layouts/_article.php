...
<div class="newsBlock">
    <div class="outNBHide">
        ...
        <ul class="NBUl">
            <li>
                <h3 class="NBH3"><a href="javascript:void(0)">Сервер mail.ru не найден из-за ошибки поиска DNS в интернет-адрес</a></h3>
                <div class="NBcontent">
                    <img src="<?=$layoutPath?>/img/NBcontentIMG.png" alt="" />
                    <div class="NBcontentIn">
                        <span class="date">21.07.2012</span>
                        <p>Сервер mail.ru не найден из-за ошибки поиска DNS (веб-службы, которая преобразует название 11 11 11 <b class="GradiendEnd"></b></p>
                    </div>
                </div>
                <div class="likePanel">
    ...
    <div class="outFix">
        ...
        <table class="TableInFix">
            ...
            <tr>
                <td>16 янв</td>
                <td>15:30</td>
                <td class="centext"><img alt="" src="<?=$layoutPath?>/img/useronline.png">Удинезе - Интер</td>
                <td class="countTb">0 : 0</td>
            </tr>
            <tr>
                <td>16 янв</td>
                <td>15:30</td>
                <td class="centext"><img alt="" src="<?=$layoutPath?>/img/useroffline.png">Удинезе - Интер</td>
                <td class="countTb">0 : 0</td>
            </tr>
            <tr>
                <td>16 янв</td>
        ...
        <table class="TableInFix TableInFixTwo">
            <col span="1" width="45px"/>
            <col span="1" width="40px"/>
            <col span="1" width="220px"/>
            <col span="1" width="50px"/>
