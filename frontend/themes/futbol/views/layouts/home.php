...
<head>
	...
	<script type="text/javascript" src="<?=$layoutPath?>/js/jquery.jparallax.min.js"></script>
	<script type="text/javascript" src="<?=$layoutPath?>/js/jquery.event.frame.js"></script>
	<script type="text/javascript" src="<?=$layoutPath?>/js/jquery.alphanumeric.js"></script>
	<script type="text/javascript" src="<?=$layoutPath?>/js/jquery.maskedinput-1.3.min.js"></script>
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			...
			if(myDateHours.getHours() > 7 && myDateHours.getHours() < 20){
				$('#paralax').css('background', 'url(<?=$layoutPath?>/img/homeBg.jpg) no-repeat center center');
				$('#container').removeClass('night');
				$('#paralax').prepend('<div class="paralax-layer" style="width:1850px; height:1033px;"><img src="<?=$layoutPath?>/img/gate.png" style=" margin-left:-150px;"alt=""/></div>')
				$('.right_shell').css('background', 'url(<?=$layoutPath?>/img/regisWinBg.png)')
			}
			else{
				$('#paralax').css('background', 'url(<?=$layoutPath?>/img/homeNightBg.jpg) no-repeat center center');
				$('#container').addClass('night');
				$('#paralax').append('<div class="paralax-layer" style="width:2000px; height:1033px;"><img src="<?=$layoutPath?>/img/dirt.png" alt=""/></div>')
				$('#paralax').prepend('<div class="paralax-layer" style="width:1850px; height:1033px;"><img src="<?=$layoutPath?>/img/gatenight.png" style=" margin-left:-150px;"alt=""/></div>')
				$('.right_shell').css('background', '<?=$layoutPath?>/img/regisWinBg.png')
				$('.right_shell').css('background', 'url(<?=$layoutPath?>/img/regisWinBgNight.png)')
			}
